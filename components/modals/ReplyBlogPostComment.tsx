...
const ReplyBlogPostComment = ({ closeModal, post_uid, comment_uid, setRepToAppend, setNoComms }:
    {
        closeModal: () => void, post_uid: string, comment_uid: string, setRepToAppend: React.Dispatch<any>,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await window.MLS_Util.AddBlogPostComments(payload);
...
export default ReplyBlogPostComment