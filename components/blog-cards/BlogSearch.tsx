            ...
            <div className='w-full mb-5'>
                <div className=''>
                    <div className='flex items-center'>
                        ...
                        <div className={`flex items-center justify-center py-2 h-11 px-4 bg-${themeSett.primary_color}-600 border 
                            border-${themeSett.primary_color}-600 text-white hover:bg-${themeSett.primary_color}-500 hover:shadow-lg 
                            cursor-pointer`}
