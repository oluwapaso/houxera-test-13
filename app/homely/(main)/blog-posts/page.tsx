...
const BlogPostsPage = () => {
    ...
    const category = searchParams?.get("ref") as string || "";
    ...
    const no_post_added = <div className='w-full text-red-600 flex justify-center items-center min-h-30'>
                ...
                <header className="w-full h-[25dvh] bg-gray-100 relative">
                    ...
                    <div data-has-bg="yes" className=" h-full flex flex-col justify-end pb-6"
                        style={{
                            ...
                            backgroundImage: `url(${(themeSett.blogs_header_image && themeSett.blogs_header_image != "")
                                ? `../../${themeSett?.blogs_header_image}` : "../gradient-background.jpg"})`, //Remove ../../, the  ../../ is added for testing
                        }}>

                        <div className={`container mx-auto max-w-[1200px] px-3 xl:px-0 text-left relative z-20 flex flex-col`}>
                            <div className={`w-full font-medium text-white text-6xl`}>Blog Posts</div>
                        </div>
                    </div>
                                    ...
                                    <div className='lg:col-span-4'>
                                        ...
                                        {(blogsError == "" && total_page > 0) &&
                                            <ReactivePagination totalPage={total_page} curr_page={curr_page}
                                                ...
                                                url_path={`${themeSett.theme_prefix}/blog-posts?${category ? `ref=${category}&` : ""}`} />
                                        }
